          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Welcome, {(adminData as any)?.admin?.username}</p>
              </div>
            </div>
            <Button 
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-slate-700/50 rounded-lg border border-slate-600">
                    ...
                    <div className="text-sm text-slate-400 space-y-1">
                      <p>Username: <span className="text-white">{(adminData as any)?.admin?.username}</span></p>
                      <p>Email: <span className="text-white">{(adminData as any)?.admin?.email}</span></p>
