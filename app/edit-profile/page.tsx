...
export default function EditProfile() {  const router = useRouter();
  ...
  const [formData, setFormData] = useState({
    ...
    bio: "",
    website: "",
    areaOfExpertise: (null as any)?.areaOfExpertise?.join(", ") || "",
    workingRegions: (null as any)?.workingRegions?.join(", ") || "",
  });
