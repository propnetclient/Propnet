...
import { Smartphone, MessageSquare, ArrowLeft, CheckCircle2 } from "lucide-react";
...
export default function PhoneVerification() {  const router = useRouter();
      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-t-lg">
          <div className="flex items-center justify-center mb-2">
            {showOtpInput ? <MessageSquare className="h-8 w-8" /> : <Smartphone className="h-8 w-8" />}
          </div>
          <CardTitle className="text-2xl font-bold">
            {showOtpInput ? "Verify Your Phone" : "Get Started"}
          </CardTitle>
