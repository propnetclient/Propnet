...
export default function Profile() {
  ...
  const pendingRequests = colistingRequests.filter((req: any) => req.status === "pending").length;
  ...
  const menuItems = [
    ...
    },
    {
      icon: Home,
      label: "My Listings",
      action: () => toast({ title: "My Listings", description: `You have ${myProperties.length} active listings` }),
    },
    {
      icon: Handshake,
